...
INSERT INTO `armada` (`id`, `nama`, `kursi`, `deskripsi`, `gambar`) VALUES
(1, 'Bus Besar', 60, 'Bus besar cocok untuk perjalanan rombongan besar seperti wisata, ziarah, atau kunjungan perusahaan.', 'armada10.jpg'),
(2, 'Mini Bus', 41, 'Mini bus adalah pilihan ideal untuk kelompok menengah seperti keluarga besar, rombongan sekolah, atau outing kantor. Ukurannya lebih ringkas dari bus besar namun tetap nyaman dan dilengkapi fasilitas standar seperti AC, audio-video, dan reclining seat.\r\n', 'mini_bus.jpg'),
(3, 'Bus Elf', 17, 'Bus elf banyak digunakan untuk city tour, antar-jemput bandara, atau perjalanan antar kota. Dengan bodi yang ramping dan manuver lincah, cocok untuk perjalanan ke daerah sempit. Tetap dilengkapi AC, audio, dan bagasi secukupnya.\r\n', 'elf_bus.jpg'),
(4, 'Bus Hiace', 15, 'Hiace merupakan minibus premium yang nyaman untuk perjalanan keluarga, tamu VIP, atau rombongan kecil. Interior elegan, kursi empuk, AC double blower, dan USB charger menjadikan Hiace pilihan populer untuk kenyamanan maksimal.', 'hiace_bus.jpg');
